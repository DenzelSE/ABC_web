...
export default function FullscreenCarousel() {
  return (
    <div className="flex min-h-screen justify-between px-8 bg-gradient-to-r from-[#D8CFC4] to-[#AFAFAF] opacity-80">
      {/* Island 1 */}
      <div className="min-w-[300px] max-w-[500px] h-full bg-[#D1D1D1] flex flex-col items-center justify-center text-white snap-start pt-20 rounded-2xl overflow-hidden px-14">
        {/* Image on top */}
